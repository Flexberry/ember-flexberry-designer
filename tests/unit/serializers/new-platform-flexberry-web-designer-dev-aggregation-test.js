...
moduleForModel('new-platform-flexberry-web-designer-dev-aggregation', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-aggregation', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-aggregation',
    'transform:file',
    'transform:decimal',
