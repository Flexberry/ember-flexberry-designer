...
moduleForModel('new-platform-flexberry-web-designer-dev-base-association', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-base-association', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-base-association',
    'transform:file',
    'transform:decimal',
