...
moduleForModel('new-platform-flexberry-web-designer-dev-u-m-l-d-p-d', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-u-m-l-d-p-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-u-m-l-d-p-d',
    'transform:file',
    'transform:decimal',
