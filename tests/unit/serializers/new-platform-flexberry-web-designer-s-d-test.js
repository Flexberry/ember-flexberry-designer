...
moduleForModel('new-platform-flexberry-web-designer-s-d', 'Unit | Serializer | new-platform-flexberry-web-designer-s-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-s-d',
    'transform:file',
    'transform:decimal',
