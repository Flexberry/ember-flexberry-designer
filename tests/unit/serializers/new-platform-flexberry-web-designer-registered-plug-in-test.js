...
moduleForModel('new-platform-flexberry-web-designer-registered-plug-in', 'Unit | Serializer | new-platform-flexberry-web-designer-registered-plug-in', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-registered-plug-in',
    'transform:file',
    'transform:decimal',
