...
moduleForModel('new-platform-flexberry-web-designer-u-c-d', 'Unit | Serializer | new-platform-flexberry-web-designer-u-c-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-u-c-d',
    'transform:file',
    'transform:decimal',
