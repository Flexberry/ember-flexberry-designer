...
moduleForModel('new-platform-flexberry-web-designer-dev-type-definition', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-type-definition', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-type-definition',
    'transform:file',
    'transform:decimal',
