...
moduleForModel('new-platform-flexberry-web-designer-class', 'Unit | Serializer | new-platform-flexberry-web-designer-class', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-class',
    'transform:file',
    'transform:decimal',
