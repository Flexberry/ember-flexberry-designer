...
moduleForModel('new-platform-flexberry-web-designer-filelink', 'Unit | Serializer | new-platform-flexberry-web-designer-filelink', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-filelink',
    'transform:file',
    'transform:decimal',
