...
moduleForModel('new-platform-flexberry-web-designer-repository-ref-data-object', 'Unit | Serializer | new-platform-flexberry-web-designer-repository-ref-data-object', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-repository-ref-data-object',
    'transform:file',
    'transform:decimal',
