...
moduleForModel('new-platform-flexberry-web-designer-plugin-on-rep-object', 'Unit | Serializer | new-platform-flexberry-web-designer-plugin-on-rep-object', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-plugin-on-rep-object',
    'transform:file',
    'transform:decimal',
