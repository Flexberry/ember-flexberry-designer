...
moduleForModel('new-platform-flexberry-web-designer-dev-class', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-class', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-class',
    'transform:file',
    'transform:decimal',
