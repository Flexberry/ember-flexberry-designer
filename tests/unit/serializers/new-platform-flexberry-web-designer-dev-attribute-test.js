...
moduleForModel('new-platform-flexberry-web-designer-dev-attribute', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-attribute', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-attribute',
    'transform:file',
    'transform:decimal',
