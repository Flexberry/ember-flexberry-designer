...
moduleForModel('new-platform-flexberry-web-designer-dev-association', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-association', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-association',
    'transform:file',
    'transform:decimal',
