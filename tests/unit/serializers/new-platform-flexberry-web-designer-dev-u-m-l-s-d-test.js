...
moduleForModel('new-platform-flexberry-web-designer-dev-u-m-l-s-d', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-u-m-l-s-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-u-m-l-s-d',
    'transform:file',
    'transform:decimal',
