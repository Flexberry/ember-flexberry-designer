...
moduleForModel('new-platform-flexberry-web-designer-object-in-system', 'Unit | Serializer | new-platform-flexberry-web-designer-object-in-system', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-object-in-system',
    'transform:file',
    'transform:decimal',
