...
moduleForModel('new-platform-flexberry-web-designer-form-view', 'Unit | Serializer | new-platform-flexberry-web-designer-form-view', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-form-view',
    'transform:file',
    'transform:decimal',
