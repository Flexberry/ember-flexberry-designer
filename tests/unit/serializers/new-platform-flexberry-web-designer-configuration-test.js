...
moduleForModel('new-platform-flexberry-web-designer-configuration', 'Unit | Serializer | new-platform-flexberry-web-designer-configuration', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-configuration',
    'transform:file',
    'transform:decimal',
