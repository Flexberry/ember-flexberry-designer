...
moduleForModel('new-platform-flexberry-web-designer-aggregation', 'Unit | Serializer | new-platform-flexberry-web-designer-aggregation', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-aggregation',
    'transform:file',
    'transform:decimal',
