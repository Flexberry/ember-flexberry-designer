...
moduleForModel('new-platform-flexberry-web-designer-d-p-d', 'Unit | Serializer | new-platform-flexberry-web-designer-d-p-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-d-p-d',
    'transform:file',
    'transform:decimal',
