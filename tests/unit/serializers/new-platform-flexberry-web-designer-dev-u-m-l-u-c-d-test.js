...
moduleForModel('new-platform-flexberry-web-designer-dev-u-m-l-u-c-d', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-u-m-l-u-c-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-u-m-l-u-c-d',
    'transform:file',
    'transform:decimal',
