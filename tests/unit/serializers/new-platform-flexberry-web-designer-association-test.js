...
moduleForModel('new-platform-flexberry-web-designer-association', 'Unit | Serializer | new-platform-flexberry-web-designer-association', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-association',
    'transform:file',
    'transform:decimal',
