...
moduleForModel('new-platform-flexberry-web-designer-c-a-d', 'Unit | Serializer | new-platform-flexberry-web-designer-c-a-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-c-a-d',
    'transform:file',
    'transform:decimal',
