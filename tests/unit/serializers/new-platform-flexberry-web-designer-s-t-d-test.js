...
moduleForModel('new-platform-flexberry-web-designer-s-t-d', 'Unit | Serializer | new-platform-flexberry-web-designer-s-t-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-s-t-d',
    'transform:file',
    'transform:decimal',
