...
moduleForModel('new-platform-flexberry-web-designer-stage', 'Unit | Serializer | new-platform-flexberry-web-designer-stage', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-stage',
    'transform:file',
    'transform:decimal',
