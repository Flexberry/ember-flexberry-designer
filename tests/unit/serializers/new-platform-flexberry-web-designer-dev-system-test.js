...
moduleForModel('new-platform-flexberry-web-designer-dev-system', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-system', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-system',
    'transform:file',
    'transform:decimal',
