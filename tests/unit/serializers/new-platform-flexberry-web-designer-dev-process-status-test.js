...
moduleForModel('new-platform-flexberry-web-designer-dev-process-status', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-process-status', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-process-status',
    'transform:file',
    'transform:decimal',
