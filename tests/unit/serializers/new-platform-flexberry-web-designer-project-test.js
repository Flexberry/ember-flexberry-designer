...
moduleForModel('new-platform-flexberry-web-designer-project', 'Unit | Serializer | new-platform-flexberry-web-designer-project', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-project',
    'transform:file',
    'transform:decimal',
