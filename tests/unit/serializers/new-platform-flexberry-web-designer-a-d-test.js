...
moduleForModel('new-platform-flexberry-web-designer-a-d', 'Unit | Serializer | new-platform-flexberry-web-designer-a-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-a-d',
    'transform:file',
    'transform:decimal',
