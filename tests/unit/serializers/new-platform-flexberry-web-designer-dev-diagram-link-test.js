...
moduleForModel('new-platform-flexberry-web-designer-dev-diagram-link', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-diagram-link', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-diagram-link',
    'transform:file',
    'transform:decimal',
