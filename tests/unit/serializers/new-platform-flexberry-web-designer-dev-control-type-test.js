...
moduleForModel('new-platform-flexberry-web-designer-dev-control-type', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-control-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-control-type',
    'transform:file',
    'transform:decimal',
