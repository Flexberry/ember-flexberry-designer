...
moduleForModel('new-platform-flexberry-web-designer-inheritance', 'Unit | Serializer | new-platform-flexberry-web-designer-inheritance', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-inheritance',
    'transform:file',
    'transform:decimal',
