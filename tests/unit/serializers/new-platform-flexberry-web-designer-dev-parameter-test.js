...
moduleForModel('new-platform-flexberry-web-designer-dev-parameter', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-parameter', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-parameter',
    'transform:file',
    'transform:decimal',
