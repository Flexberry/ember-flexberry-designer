...
moduleForModel('new-platform-flexberry-web-designer-repository', 'Unit | Serializer | new-platform-flexberry-web-designer-repository', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-repository',
    'transform:file',
    'transform:decimal',
