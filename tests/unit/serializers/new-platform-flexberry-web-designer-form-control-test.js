...
moduleForModel('new-platform-flexberry-web-designer-form-control', 'Unit | Serializer | new-platform-flexberry-web-designer-form-control', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-form-control',
    'transform:file',
    'transform:decimal',
