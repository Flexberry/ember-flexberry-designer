...
moduleForModel('new-platform-flexberry-web-designer-case-property', 'Unit | Serializer | new-platform-flexberry-web-designer-case-property', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-case-property',
    'transform:file',
    'transform:decimal',
