...
moduleForModel('new-platform-flexberry-web-designer-dev-task', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-task', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-task',
    'transform:file',
    'transform:decimal',
