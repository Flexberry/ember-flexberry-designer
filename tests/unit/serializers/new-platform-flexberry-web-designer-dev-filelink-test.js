...
moduleForModel('new-platform-flexberry-web-designer-dev-filelink', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-filelink', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-filelink',
    'transform:file',
    'transform:decimal',
