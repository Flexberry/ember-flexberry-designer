...
moduleForModel('new-platform-flexberry-web-designer-dev-inheritance', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-inheritance', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-inheritance',
    'transform:file',
    'transform:decimal',
