...
moduleForModel('new-platform-flexberry-web-designer-repository-object-with-plugins', 'Unit | Serializer | new-platform-flexberry-web-designer-repository-object-with-plugins', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-repository-object-with-plugins',
    'transform:file',
    'transform:decimal',
