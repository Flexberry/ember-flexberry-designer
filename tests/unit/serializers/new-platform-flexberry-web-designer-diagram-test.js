...
moduleForModel('new-platform-flexberry-web-designer-diagram', 'Unit | Serializer | new-platform-flexberry-web-designer-diagram', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-diagram',
    'transform:file',
    'transform:decimal',
