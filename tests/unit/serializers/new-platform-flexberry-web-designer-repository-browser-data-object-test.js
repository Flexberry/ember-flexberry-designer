...
moduleForModel('new-platform-flexberry-web-designer-repository-browser-data-object', 'Unit | Serializer | new-platform-flexberry-web-designer-repository-browser-data-object', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-repository-browser-data-object',
    'transform:file',
    'transform:decimal',
