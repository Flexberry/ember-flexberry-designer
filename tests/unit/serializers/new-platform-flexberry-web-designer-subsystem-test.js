...
moduleForModel('new-platform-flexberry-web-designer-subsystem', 'Unit | Serializer | new-platform-flexberry-web-designer-subsystem', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-subsystem',
    'transform:file',
    'transform:decimal',
