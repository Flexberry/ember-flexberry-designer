...
moduleForModel('new-platform-flexberry-web-designer-dev-form-control', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-form-control', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-form-control',
    'transform:file',
    'transform:decimal',
