...
moduleForModel('fd-repository-browser-data-object-with-a-c-l', 'Unit | Serializer | fd-repository-browser-data-object-with-a-c-l', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:fd-repository-browser-data-object-with-a-c-l',
    'transform:file',
    'transform:decimal',
    'transform:guid',
