...
moduleForModel('new-platform-flexberry-web-designer-dev-associated-detail-view', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-associated-detail-view', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-associated-detail-view',
    'transform:file',
    'transform:decimal',
