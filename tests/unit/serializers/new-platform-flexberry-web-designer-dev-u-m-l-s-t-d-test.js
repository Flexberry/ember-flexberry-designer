...
moduleForModel('new-platform-flexberry-web-designer-dev-u-m-l-s-t-d', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-u-m-l-s-t-d', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-u-m-l-s-t-d',
    'transform:file',
    'transform:decimal',
