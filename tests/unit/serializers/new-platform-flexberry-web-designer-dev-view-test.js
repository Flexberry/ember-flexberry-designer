...
moduleForModel('new-platform-flexberry-web-designer-dev-view', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-view', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-view',
    'transform:file',
    'transform:decimal',
