...
moduleForModel('new-platform-flexberry-web-designer-view', 'Unit | Serializer | new-platform-flexberry-web-designer-view', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-view',
    'transform:file',
    'transform:decimal',
