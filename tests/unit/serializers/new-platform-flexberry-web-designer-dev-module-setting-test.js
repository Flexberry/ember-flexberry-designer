...
moduleForModel('new-platform-flexberry-web-designer-dev-module-setting', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-module-setting', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-module-setting',
    'transform:file',
    'transform:decimal',
