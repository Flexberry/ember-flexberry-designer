...
moduleForModel('new-platform-flexberry-web-designer-dev-module-setting-type', 'Unit | Serializer | new-platform-flexberry-web-designer-dev-module-setting-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-flexberry-web-designer-dev-module-setting-type',
    'transform:file',
    'transform:decimal',
