...
define('dummy/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('unit/transforms/fd-definition-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/transforms/fd-definition-test.js should pass ESLint\n\n');
  });
...
define('dummy/tests/unit/transforms/fd-definition-test', ['ember-qunit', 'ember-flexberry-designer/objects/fd-view-attributes-property', 'ember-flexberry-designer/objects/fd-view-attributes-master', 'ember-flexberry-designer/objects/fd-view-attributes-detail'], function (_emberQunit, _fdViewAttributesProperty, _fdViewAttributesMaster, _fdViewAttributesDetail) {
  'use strict';
