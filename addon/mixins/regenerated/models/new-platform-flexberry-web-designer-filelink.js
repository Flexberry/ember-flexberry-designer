...
export let Model = Ember.Mixin.create({
  ...
  */
  ...
  subsystem: DS.belongsTo('new-platform-flexberry-web-designer-subsystem', { inverse: 'filelinks', async: false, polymorphic: true }),
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('FileLink', 'new-platform-flexberry-web-designer-filelink', {
