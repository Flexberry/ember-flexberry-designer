...
export let Model = Ember.Mixin.create({
  ...
  */
  ...
  subsystem: DS.belongsTo('new-platform-flexberry-web-designer-subsystem', { inverse: 'diagrams', async: false, polymorphic: true }),
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('Diagram', 'new-platform-flexberry-web-designer-diagram', {
  ...
  modelClass.defineProjection('DiagramWithStage', 'new-platform-flexberry-web-designer-diagram', {
    primitivesStreamString: Projection.attr(''),
    caseObjectsString: Projection.attr(''),
    name: Projection.attr(''),
    createDate: Projection.attr(''),
  ...
  modelClass.defineProjection('DiagramWithSystem', 'new-platform-flexberry-web-designer-diagram', {
    primitivesStreamString: Projection.attr(''),
    caseObjectsString: Projection.attr(''),
    name: Projection.attr(''),
    createDate: Projection.attr(''),
  ...
  modelClass.defineProjection('ExportToWmf', 'new-platform-flexberry-web-designer-diagram', {
    name: Projection.attr(''),
    description: Projection.attr('')
  });
  modelClass.defineProjection('SearchSystem', 'new-platform-flexberry-web-designer-diagram', {
    name: Projection.attr('')
  });
};
