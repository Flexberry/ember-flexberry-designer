...
export let Model = Ember.Mixin.create({
  ...
  */
  ...
  typeDefinitions: DS.hasMany('new-platform-flexberry-web-designer-dev-type-definition', { inverse: 'stage', async: false }),
  controlTypes: DS.hasMany('new-platform-flexberry-web-designer-dev-control-type', { inverse: 'stage', async: false }),
  moduleSettings: DS.hasMany('new-platform-flexberry-web-designer-dev-module-setting', { inverse: 'stage', async: false }),
...
export let defineBaseModel = function (modelClass) {
  modelClass.reopenClass({
    _parentModelName: 'new-platform-flexberry-web-designer-stage'
  });
};

export let defineProjections = function (modelClass) {
  modelClass.defineProjection('AuditPrototyping', 'new-platform-flexberry-web-designer-dev-stage', {
    typeMapCS: Projection.attr(''),
    typeMapCSStr: Projection.attr('')
  });
  modelClass.defineProjection('Backup', 'new-platform-flexberry-web-designer-dev-stage', {
  ...
  modelClass.defineProjection('Compiler', 'new-platform-flexberry-web-designer-dev-stage', {
    company: Projection.attr(''),
    product: Projection.attr(''),
    copyright: Projection.attr(''),
    version: Projection.attr(''),
  ...
  modelClass.defineProjection('EditAccessGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    ...
    moduleSettings: Projection.hasMany('new-platform-flexberry-web-designer-dev-module-setting', '', {
  ...
  modelClass.defineProjection('EditCSGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название стадии'),
    description: Projection.attr('Описание'),
  ...
  modelClass.defineProjection('EditFormView', 'new-platform-flexberry-web-designer-dev-stage', {
  ...
  modelClass.defineProjection('EditMSSQLDirectGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название стадии'),
    description: Projection.attr('Описание'),
  ...
  modelClass.defineProjection('EditOracleGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название стадии'),
    description: Projection.attr('Описание'),
    sQLPath: Projection.attr(''),
  ...
  modelClass.defineProjection('EditPostgreSqlDirectGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название стадии'),
    description: Projection.attr('Описание'),
  ...
  modelClass.defineProjection('EditPropertyLookups', 'new-platform-flexberry-web-designer-dev-stage', {
    
  });
  modelClass.defineProjection('EditRightManagementGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название стадии'),
    description: Projection.attr('Описание'),
  ...
  modelClass.defineProjection('EditSQLGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название стадии'),
    description: Projection.attr('Описание'),
    sQLPath: Projection.attr(''),
    typeMapSQLStr: Projection.attr('', { hidden: true }),
  ...
  modelClass.defineProjection('EditVBGenerator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название стадии'),
    description: Projection.attr('Описание'),
    company: Projection.attr(''),
    product: Projection.attr(''),
  ...
  modelClass.defineProjection('FormDesigner_ProjectE', 'new-platform-flexberry-web-designer-dev-stage', {
  ...
  modelClass.defineProjection('FormDesigner_ProjectL', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Название'),
    description: Projection.attr('Описание'),
  ...
  modelClass.defineProjection('Generator', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr(''),
    description: Projection.attr(''),
    company: Projection.attr(''),
    product: Projection.attr(''),
    ...
    defaultWriteMode: Projection.attr(''),
    isReportDatabaseLocal: Projection.attr(''),
    typeDefinitions: Projection.hasMany('new-platform-flexberry-web-designer-dev-type-definition', '', {
      name: Projection.attr(''),
    ...
    controlTypes: Projection.hasMany('new-platform-flexberry-web-designer-dev-control-type', '', {
  ...
  modelClass.defineProjection('IntelliSearchPluginIndexing', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr(''),
  ...
  modelClass.defineProjection('IntelliSearchPluginLight', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr(''),
    changeDate: Projection.attr(''),
    lastIndexDate: Projection.attr(''),
    indexComment: Projection.attr(''),
  ...
  modelClass.defineProjection('IntelliSearchPluginSearch', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr(''),
    changeDate: Projection.attr(''),
    lastIndexDate: Projection.attr(''),
    indexComment: Projection.attr(''),
  ...
  modelClass.defineProjection('LightStage', 'new-platform-flexberry-web-designer-dev-stage', {
    company: Projection.attr(''),
    product: Projection.attr(''),
    sourceCodeCSPath: Projection.attr(''),
    moduleSettings: Projection.hasMany('new-platform-flexberry-web-designer-dev-module-setting', '', {
  ...
  modelClass.defineProjection('ListDataObjectTypes', 'new-platform-flexberry-web-designer-dev-stage', {
    
  });
  modelClass.defineProjection('ListFormView', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('Name'),
    description: Projection.attr('Description'),
  ...
  modelClass.defineProjection('Prototyping', 'new-platform-flexberry-web-designer-dev-stage', {
    
  });
  modelClass.defineProjection('SearchRepObjView', 'new-platform-flexberry-web-designer-dev-stage', {
    name: Projection.attr('')
  });
  modelClass.defineProjection('ViewPeeker', 'new-platform-flexberry-web-designer-dev-stage', {
