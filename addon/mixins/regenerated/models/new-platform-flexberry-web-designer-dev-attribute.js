...
export let Model = Ember.Mixin.create({
  ...
  */
  ...
  type: DS.attr('string'),
  class: DS.belongsTo('new-platform-flexberry-web-designer-dev-class', { inverse: 'attributes', async: false }),
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('AuditPrototyping', 'new-platform-flexberry-web-designer-dev-attribute', {
  ...
  modelClass.defineProjection('EditApplication', 'new-platform-flexberry-web-designer-dev-attribute', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditDataObjectClass', 'new-platform-flexberry-web-designer-dev-attribute', {
    accessModifier: Projection.attr(''),
    stored: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
  ...
  modelClass.defineProjection('EditEditForm', 'new-platform-flexberry-web-designer-dev-attribute', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditEnum', 'new-platform-flexberry-web-designer-dev-attribute', {
    name: Projection.attr(''),
    description: Projection.attr(''),
    defaultValue: Projection.attr(''),
    caption: Projection.attr('')
  });
  modelClass.defineProjection('EditInterface', 'new-platform-flexberry-web-designer-dev-attribute', {
    name: Projection.attr(''),
    type: Projection.attr(''),
    description: Projection.attr('')
  });
  modelClass.defineProjection('EditListForm', 'new-platform-flexberry-web-designer-dev-attribute', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditPrintForm', 'new-platform-flexberry-web-designer-dev-attribute', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditType', 'new-platform-flexberry-web-designer-dev-attribute', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditUserForm', 'new-platform-flexberry-web-designer-dev-attribute', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('FormDesigner', 'new-platform-flexberry-web-designer-dev-attribute', {
    name: Projection.attr(''),
    type: Projection.attr(''),
    caption: Projection.attr(''),
    description: Projection.attr(''),
  ...
  modelClass.defineProjection('Generator', 'new-platform-flexberry-web-designer-dev-attribute', {
  ...
  modelClass.defineProjection('SearchAttribute', 'new-platform-flexberry-web-designer-dev-attribute', {
    name: Projection.attr(''),
    type: Projection.attr(''),
    class: Projection.belongsTo('new-platform-flexberry-web-designer-dev-class', '', {
