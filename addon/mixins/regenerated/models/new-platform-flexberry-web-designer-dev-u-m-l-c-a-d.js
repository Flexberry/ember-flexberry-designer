...
export let defineBaseModel = function (modelClass) {
  modelClass.reopenClass({
    _parentModelName: 'new-platform-flexberry-web-designer-c-a-d'
  });
};

export let defineProjections = function (modelClass) {
  modelClass.defineProjection('EditFormView', 'new-platform-flexberry-web-designer-dev-u-m-l-c-a-d', {
    name: Projection.attr('Name'),
    description: Projection.attr('Description')
  });
  modelClass.defineProjection('ListFormView', 'new-platform-flexberry-web-designer-dev-u-m-l-c-a-d', {
    name: Projection.attr('Name'),
    description: Projection.attr('Description'),
  ...
  modelClass.defineProjection('SearchDiagram', 'new-platform-flexberry-web-designer-dev-u-m-l-c-a-d', {
