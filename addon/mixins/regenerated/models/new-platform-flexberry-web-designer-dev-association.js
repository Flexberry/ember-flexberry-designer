...
export let defineBaseModel = function (modelClass) {
  modelClass.reopenClass({
    _parentModelName: 'new-platform-flexberry-web-designer-dev-base-association'
  });
};

export let defineProjections = function (modelClass) {
  modelClass.defineProjection('Edit', 'new-platform-flexberry-web-designer-dev-association', {
  ...
  modelClass.defineProjection('EditFormView', 'new-platform-flexberry-web-designer-dev-association', {
    name: Projection.attr('Name'),
    description: Projection.attr('Description')
  });
  modelClass.defineProjection('FormDesigner', 'new-platform-flexberry-web-designer-dev-association', {
  ...
  modelClass.defineProjection('Gen', 'new-platform-flexberry-web-designer-dev-association', {
    pBMasterCustomAttributes: Projection.attr(''),
    pBMasterGetEnd: Projection.attr(''),
    pBMasterGetStart: Projection.attr(''),
    storage: Projection.attr(''),
  ...
  modelClass.defineProjection('Generator', 'new-platform-flexberry-web-designer-dev-association', {
  ...
  modelClass.defineProjection('ListFormView', 'new-platform-flexberry-web-designer-dev-association', {
