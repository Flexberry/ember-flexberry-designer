...
export let Model = Ember.Mixin.create({
  ...
  */
  ...
  class: DS.belongsTo('new-platform-flexberry-web-designer-dev-class', { inverse: 'methods', async: false }),
  parameters: DS.hasMany('new-platform-flexberry-web-designer-dev-parameter', { inverse: 'method', async: false }),
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('AddOperations', 'new-platform-flexberry-web-designer-dev-method', {
    name: Projection.attr(''),
    parametersStr: Projection.attr(''),
    accessType: Projection.attr('')
  });
  modelClass.defineProjection('EditApplication', 'new-platform-flexberry-web-designer-dev-method', {
  ...
  modelClass.defineProjection('EditBusinessServer', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditDataObjectClass', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    type: Projection.attr(''),
    parametersStr: Projection.attr('', { hidden: true }),
    isEvent: Projection.attr(''),
  ...
  modelClass.defineProjection('EditEditForm', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
  ...
  modelClass.defineProjection('EditInterface', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditListForm', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    caption: Projection.attr(''),
    description: Projection.attr(''),
  ...
  modelClass.defineProjection('EditPrintForm', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    caption: Projection.attr(''),
    description: Projection.attr(''),
  ...
  modelClass.defineProjection('EditType', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    description: Projection.attr(''),
    type: Projection.attr(''),
  ...
  modelClass.defineProjection('EditUserForm', 'new-platform-flexberry-web-designer-dev-method', {
    accessModifier: Projection.attr(''),
    name: Projection.attr(''),
    caption: Projection.attr(''),
    description: Projection.attr(''),
  ...
  modelClass.defineProjection('Generator', 'new-platform-flexberry-web-designer-dev-method', {
