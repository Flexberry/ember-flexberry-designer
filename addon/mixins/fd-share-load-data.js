 ...
 */
  beforeModel: function(transition) {
    ...
    .then(() => this._processGotoObj(gotoobj, gototype))
    .finally(() => {
  ...
  /**
    Process gotoobj and gotoobj query parameters to set selectObjectId.

    @method _processGotoObj
    @param {String} gotoobj The gotoobj query parameter value
    @param {String} gototype The gototype query parameter value
    @return {Promise} Resolves when processing is complete
  */
  _processGotoObj: function(gotoobj, gototype) {
    if (isBlank(gotoobj)) {
      return resolve();
    }
