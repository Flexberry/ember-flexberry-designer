export default {
  ...
  'empty-name': 'Имя не может быть пустым',
  'exist-stage': 'Проект с таким именем уже существует',
  'import-project': 'Создать проект на основе сохраненного файла',
};
