export default {
  ...
  cancel: 'Отменить',
  'error-message': {
    'empty-class': 'Ошибка: имя у класса не может быть пустое',
    'exist-class': 'Ошибка: класс с таким именем уже существует',
    'view-form': 'Ошибка: Составное представление не указано'
  }
};
