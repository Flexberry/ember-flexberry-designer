export default {
  ...
  'edit-caption': 'Правка',
  'custom-message': {
    'validate-header': 'Обноружены ошибки в модели',
    'validate-approve': 'Запустить авто корректор',
    'validate-deny': 'Поправить самому',
    'lock-stage': 'Один или несколько объектов проекта заблокирован, запуск корректора не возможен',
    'corrector-header': 'Проект исправлен',
